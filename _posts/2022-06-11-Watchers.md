...
Watchers are created from bunch of UnityEngine.UIElements and UnityEditor.UIElements.
...
### Boards
Board inherits from Unity native GraphView. It is the place where you can add your Nodes. Boards can contain multiple cards.
